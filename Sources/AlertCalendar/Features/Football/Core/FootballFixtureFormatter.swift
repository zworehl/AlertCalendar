...
enum FootballFixtureFormatter {
    ...
    private static func normalizedSeriesLegLabel(for seriesSummary: FootballFixtureSeriesSummary?) -> String? {
    ...
    private static func parsedLegLabel(from competitionNote: String?) -> String? {
    ...
    private static func parsedAggregateSummaryText(from competitionNote: String?) -> String? {
        guard let competitionNote else { return nil }
        let normalizedNote = competitionNote.trimmingCharacters(in: .whitespacesAndNewlines)
        guard !normalizedNote.isEmpty else { return nil }
    ...
    private static func parsedAggregateScores(from competitionNote: String?) -> (home: String, away: String)? {
        guard let competitionNote else { return nil }
        let normalizedNote = competitionNote.trimmingCharacters(in: .whitespacesAndNewlines)
        guard !normalizedNote.isEmpty else { return nil }
