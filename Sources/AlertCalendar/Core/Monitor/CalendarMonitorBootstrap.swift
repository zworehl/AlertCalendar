...
extension CalendarMonitor {
    ...
    func registerDefaultSettings() {
        defaults.register(defaults: [
            ...
            DefaultsKeys.includeSunriseSunset: true,
            DefaultsKeys.includeSolarNoonMidnight: true,
            DefaultsKeys.includeMoonPhases: true,
            DefaultsKeys.includeOrbitalHighlights: true,
            ...
            DefaultsKeys.contextualPreviewLeadMinutes: 120,
